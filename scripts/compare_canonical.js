...
const CANON = path.resolve(__dirname, '../data/canonical_vignanam_telugu.json');
...
function main() {
  ...
  fs.writeFileSync(path.resolve(__dirname, '../data/verification_report.json'), JSON.stringify(report, null, 2), 'utf8');
  console.log('\nWrote data/verification_report.json with full details.');
}
